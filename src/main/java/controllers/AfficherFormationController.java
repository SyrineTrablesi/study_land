...
//                    ImageView imageView = new ImageView(new Image("/img/mobile.jpg"));
...
//                    ImageView deleteIcon = new ImageView(new Image("/img/mobile.jpg"));
...
//    public void btnAjouterPanier(ActionEvent actionEvent) {
//        if (selectedFormation != null) {
//            Panier panier = new Panier(1,1,selectedFormation.getTitre());
//
//
//
//           /* panier.setDescription(selectedFormation.getDescription() != null ? selectedFormation.getDescription() : "No description available");
//            panier.setNiveau(selectedFormation.getNiveau());
//            panier.setTitre(selectedFormation.getTitre());
//            panier.setPrix(selectedFormation.getPrix());
//            panier.setId_user(1); // Assuming you need to set the user ID
//            panier.setId_formation(selectedFormation.getIdFormation()); // Assuming you want to set the formation ID
//            panier.setDate_ajout(LocalDate.now());
//*/
//            try {
//                // Call the service method to add the formation to the panier
//                SP.ajouterPanier(panier);
//                System.out.println("Formation added to panier successfully."); // Display a success message
//            } catch (SQLException e) {
//                System.out.println("Failed to add formation to panier: " + e.getMessage()); // Display an error message if adding fails
//                // You can also handle the exception in other ways, such as showing an alert dialog to the user
//            }
//        }
//    }
//}
